...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/sites/nuitblanche1/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/var/www/sites/nuitblanche1/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/var/www/sites/nuitblanche1/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/var/www/sites/nuitblanche1/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventSubscriber($this->get('nb.doctrine.listener.game'));
        $c->addEventSubscriber($this->get('nb.doctrine.listener.gameplayer'));
        $c->addEventSubscriber($this->get('nb.doctrine.listener.player'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'nuitblanche', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, $c, array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager50fd523c62b0e_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager50fd523c62b0e_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/var/www/sites/nuitblanche1/app/cache/dev/jms_diextra/doctrine/EntityManager_50fd523c62b0e.php';

        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_45d9319b988d829ed4e9e9652de401c4');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_45d9319b988d829ed4e9e9652de401c4');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_45d9319b988d829ed4e9e9652de401c4');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/var/www/sites/nuitblanche1/src/IHQS/NuitBlancheBundle/Entity')), 'IHQS\\NuitBlancheBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('IHQSNuitBlancheBundle' => 'IHQS\\NuitBlancheBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/var/www/sites/nuitblanche1/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager50fd523c62b0e_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($f, $this);
    }
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.controller', array(0 => 'nb.controller.listener', 1 => 'onKernelController'), 0);
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/var/www/sites/nuitblanche1/app/Resources');
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/var/www/sites/nuitblanche1/app/cache/dev/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/var/www/sites/nuitblanche1/app/logs/dev.log', 100, true);
    }
    ...
    /**
     * Gets the 'nb.controller.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return IHQS\NuitBlancheBundle\ControllerListener A IHQS\NuitBlancheBundle\ControllerListener instance.
     */
    protected function getNb_Controller_ListenerService()
    {
        return $this->services['nb.controller.listener'] = new \IHQS\NuitBlancheBundle\ControllerListener($this);
    }

    /**
     * Gets the 'nb.doctrine.listener.game' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return IHQS\NuitBlancheBundle\EventSubscriber\GameEventSubscriber A IHQS\NuitBlancheBundle\EventSubscriber\GameEventSubscriber instance.
     */
    protected function getNb_Doctrine_Listener_GameService()
    {
        return $this->services['nb.doctrine.listener.game'] = new \IHQS\NuitBlancheBundle\EventSubscriber\GameEventSubscriber();
    }

    /**
     * Gets the 'nb.doctrine.listener.gameplayer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return IHQS\NuitBlancheBundle\EventSubscriber\GamePlayerEventSubscriber A IHQS\NuitBlancheBundle\EventSubscriber\GamePlayerEventSubscriber instance.
     */
    protected function getNb_Doctrine_Listener_GameplayerService()
    {
        return $this->services['nb.doctrine.listener.gameplayer'] = new \IHQS\NuitBlancheBundle\EventSubscriber\GamePlayerEventSubscriber();
    }

    /**
     * Gets the 'nb.doctrine.listener.player' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return IHQS\NuitBlancheBundle\EventSubscriber\SC2ProfileEventSubscriber A IHQS\NuitBlancheBundle\EventSubscriber\SC2ProfileEventSubscriber instance.
     */
    protected function getNb_Doctrine_Listener_PlayerService()
    {
        return $this->services['nb.doctrine.listener.player'] = new \IHQS\NuitBlancheBundle\EventSubscriber\SC2ProfileEventSubscriber();
    }

    /**
     * Gets the 'nb.manager.comment' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return IHQS\NuitBlancheBundle\Model\CommentRepository A IHQS\NuitBlancheBundle\Model\CommentRepository instance.
     */
    protected function getNb_Manager_CommentService()
    {
        return $this->services['nb.manager.comment'] = call_user_func(array('IHQS\\NuitBlancheBundle\\DependencyInjection\\IHQSNuitBlancheExtension', 'getRepository'), $this->get('doctrine.orm.default_entity_manager'), 'IHQS\\NuitBlancheBundle\\Entity\\Comment');
    }

    /**
     * Gets the 'nb.manager.game' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return IHQS\NuitBlancheBundle\Model\GameRepository A IHQS\NuitBlancheBundle\Model\GameRepository instance.
     */
    protected function getNb_Manager_GameService()
    {
        return $this->services['nb.manager.game'] = call_user_func(array('IHQS\\NuitBlancheBundle\\DependencyInjection\\IHQSNuitBlancheExtension', 'getRepository'), $this->get('doctrine.orm.default_entity_manager'), 'IHQS\\NuitBlancheBundle\\Entity\\Game');
    }

    /**
     * Gets the 'nb.manager.game_player' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return IHQS\NuitBlancheBundle\Model\GamePlayerRepository A IHQS\NuitBlancheBundle\Model\GamePlayerRepository instance.
     */
    protected function getNb_Manager_GamePlayerService()
    {
        return $this->services['nb.manager.game_player'] = call_user_func(array('IHQS\\NuitBlancheBundle\\DependencyInjection\\IHQSNuitBlancheExtension', 'getRepository'), $this->get('doctrine.orm.default_entity_manager'), 'IHQS\\NuitBlancheBundle\\Entity\\GamePlayer');
    }

    /**
     * Gets the 'nb.manager.league' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return IHQS\NuitBlancheBundle\Model\LeagueRepository A IHQS\NuitBlancheBundle\Model\LeagueRepository instance.
     */
    protected function getNb_Manager_LeagueService()
    {
        return $this->services['nb.manager.league'] = call_user_func(array('IHQS\\NuitBlancheBundle\\DependencyInjection\\IHQSNuitBlancheExtension', 'getRepository'), $this->get('doctrine.orm.default_entity_manager'), 'IHQS\\NuitBlancheBundle\\Entity\\League');
    }

    /**
     * Gets the 'nb.manager.news' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return IHQS\NuitBlancheBundle\Model\NewsRepository A IHQS\NuitBlancheBundle\Model\NewsRepository instance.
     */
    protected function getNb_Manager_NewsService()
    {
        return $this->services['nb.manager.news'] = call_user_func(array('IHQS\\NuitBlancheBundle\\DependencyInjection\\IHQSNuitBlancheExtension', 'getRepository'), $this->get('doctrine.orm.default_entity_manager'), 'IHQS\\NuitBlancheBundle\\Entity\\News');
    }

    /**
     * Gets the 'nb.manager.replay' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return IHQS\NuitBlancheBundle\Model\ReplayRepository A IHQS\NuitBlancheBundle\Model\ReplayRepository instance.
     */
    protected function getNb_Manager_ReplayService()
    {
        $this->services['nb.manager.replay'] = $instance = call_user_func(array('IHQS\\NuitBlancheBundle\\DependencyInjection\\IHQSNuitBlancheExtension', 'getRepository'), $this->get('doctrine.orm.default_entity_manager'), 'IHQS\\NuitBlancheBundle\\Entity\\Replay');

        $instance->setReplayProcessor($this->get('nb.replay.processor'));

        return $instance;
    }

    /**
     * Gets the 'nb.manager.sc2profile' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return IHQS\NuitBlancheBundle\Model\SC2ProfileRepository A IHQS\NuitBlancheBundle\Model\SC2ProfileRepository instance.
     */
    protected function getNb_Manager_Sc2profileService()
    {
        return $this->services['nb.manager.sc2profile'] = call_user_func(array('IHQS\\NuitBlancheBundle\\DependencyInjection\\IHQSNuitBlancheExtension', 'getRepository'), $this->get('doctrine.orm.default_entity_manager'), 'IHQS\\NuitBlancheBundle\\Entity\\SC2Profile');
    }

    /**
     * Gets the 'nb.manager.season' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return IHQS\NuitBlancheBundle\Model\SeasonRepository A IHQS\NuitBlancheBundle\Model\SeasonRepository instance.
     */
    protected function getNb_Manager_SeasonService()
    {
        return $this->services['nb.manager.season'] = call_user_func(array('IHQS\\NuitBlancheBundle\\DependencyInjection\\IHQSNuitBlancheExtension', 'getRepository'), $this->get('doctrine.orm.default_entity_manager'), 'IHQS\\NuitBlancheBundle\\Entity\\Season');
    }

    /**
     * Gets the 'nb.manager.team' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return IHQS\NuitBlancheBundle\Model\TeamRepository A IHQS\NuitBlancheBundle\Model\TeamRepository instance.
     */
    protected function getNb_Manager_TeamService()
    {
        return $this->services['nb.manager.team'] = call_user_func(array('IHQS\\NuitBlancheBundle\\DependencyInjection\\IHQSNuitBlancheExtension', 'getRepository'), $this->get('doctrine.orm.default_entity_manager'), 'IHQS\\NuitBlancheBundle\\Entity\\Team');
    }

    /**
     * Gets the 'nb.manager.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return IHQS\NuitBlancheBundle\Model\UserRepository A IHQS\NuitBlancheBundle\Model\UserRepository instance.
     */
    protected function getNb_Manager_UserService()
    {
        return $this->services['nb.manager.user'] = call_user_func(array('IHQS\\NuitBlancheBundle\\DependencyInjection\\IHQSNuitBlancheExtension', 'getRepository'), $this->get('doctrine.orm.default_entity_manager'), 'IHQS\\NuitBlancheBundle\\Entity\\User');
    }

    /**
     * Gets the 'nb.manager.war' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return IHQS\NuitBlancheBundle\Model\WarRepository A IHQS\NuitBlancheBundle\Model\WarRepository instance.
     */
    protected function getNb_Manager_WarService()
    {
        return $this->services['nb.manager.war'] = call_user_func(array('IHQS\\NuitBlancheBundle\\DependencyInjection\\IHQSNuitBlancheExtension', 'getRepository'), $this->get('doctrine.orm.default_entity_manager'), 'IHQS\\NuitBlancheBundle\\Entity\\War');
    }

    /**
     * Gets the 'nb.manager.war_game' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return IHQS\NuitBlancheBundle\Model\WarGameRepository A IHQS\NuitBlancheBundle\Model\WarGameRepository instance.
     */
    protected function getNb_Manager_WarGameService()
    {
        return $this->services['nb.manager.war_game'] = call_user_func(array('IHQS\\NuitBlancheBundle\\DependencyInjection\\IHQSNuitBlancheExtension', 'getRepository'), $this->get('doctrine.orm.default_entity_manager'), 'IHQS\\NuitBlancheBundle\\Entity\\WarGame');
    }

    /**
     * Gets the 'nb.manager.wowprofile' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return IHQS\NuitBlancheBundle\Model\WoWProfileRepository A IHQS\NuitBlancheBundle\Model\WoWProfileRepository instance.
     */
    protected function getNb_Manager_WowprofileService()
    {
        return $this->services['nb.manager.wowprofile'] = call_user_func(array('IHQS\\NuitBlancheBundle\\DependencyInjection\\IHQSNuitBlancheExtension', 'getRepository'), $this->get('doctrine.orm.default_entity_manager'), 'IHQS\\NuitBlancheBundle\\Entity\\WoWProfile');
    }

    /**
     * Gets the 'nb.replay.processor' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return IHQS\NuitBlancheBundle\Processor\ReplayProcessor A IHQS\NuitBlancheBundle\Processor\ReplayProcessor instance.
     */
    protected function getNb_Replay_ProcessorService()
    {
        return $this->services['nb.replay.processor'] = new \IHQS\NuitBlancheBundle\Processor\ReplayProcessor($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/var/www/sites/nuitblanche1/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/var/www/sites/nuitblanche1/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/var/www/sites/nuitblanche1/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context'), $this->get('monolog.logger.router'));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/var/www/sites/nuitblanche1/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/var/www/sites/nuitblanche1/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/sites/nuitblanche1/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/var/www/sites/nuitblanche1/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/var/www/sites/nuitblanche1/app/cache/dev/translations', 'debug' => true));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($a, array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/var/www/sites/nuitblanche1/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \IHQS\NuitBlancheBundle\Twig\Extension\InnerBlocksExtension($a, $this));
        $instance->addExtension(new \IHQS\NuitBlancheBundle\Twig\Extension\UserExtension($b));
        $instance->addExtension(new \JMS\SecurityExtraBundle\Twig\SecurityExtension($b));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/sites/nuitblanche1/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        return $this->services['validator'] = new \Symfony\Component\Validator\Validator($this->get('validator.mapping.class_metadata_factory'), new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array('security.validator.user_password' => 'security.validator.user_password', 'doctrine.orm.validator.unique' => 'doctrine.orm.validator.unique', 'Unique' => 'validator.unique.unique')), array(0 => $this->get('doctrine.orm.validator_initializer')));
    }

    /**
     * Gets the 'validator.unique.unique' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return IHQS\NuitBlancheBundle\Validator\UniqueValidator A IHQS\NuitBlancheBundle\Validator\UniqueValidator instance.
     */
    protected function getValidator_Unique_UniqueService()
    {
        return $this->services['validator.unique.unique'] = new \IHQS\NuitBlancheBundle\Validator\UniqueValidator($this->get('doctrine.orm.default_entity_manager'));
    }
     ...
     *
     * @return EntityManager50fd523c62b0e_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    /**
     * Gets the nb.entity_manager service alias.
     *
     * @return EntityManager50fd523c62b0e_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    protected function getNb_EntityManagerService()
    {
        return $this->get('doctrine.orm.default_entity_manager');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/var/www/sites/nuitblanche1/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/var/www/sites/nuitblanche1/app/cache/dev/assetic/assets');
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/var/www/sites/nuitblanche1/app/cache/dev/jms_security/expressions');
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/var/www/sites/nuitblanche1/app/cache/dev/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/sites/nuitblanche1/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/var/www/sites/nuitblanche1/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/sites/nuitblanche1/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/sites/nuitblanche1/app/cache/dev',
            'kernel.logs_dir' => '/var/www/sites/nuitblanche1/app/logs',
            'kernel.bundles' => array(
                ...
                'IHQSNuitBlancheBundle' => 'IHQS\\NuitBlancheBundle\\IHQSNuitBlancheBundle',
            ...
            'debug.container.dump' => '/var/www/sites/nuitblanche1/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/var/www/sites/nuitblanche1/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/var/www/sites/nuitblanche1/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/var/www/sites/nuitblanche1/app/cache/dev/profiler',
            ...
            'router.resource' => '/var/www/sites/nuitblanche1/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/sites/nuitblanche1/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => '/var/www/sites/nuitblanche1/app/cache/dev/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/var/www/sites/nuitblanche1/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/var/www/sites/nuitblanche1/app/../web',
            'assetic.write_to' => '/var/www/sites/nuitblanche1/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/sites/nuitblanche1/app/cache/dev/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/var/www/sites/nuitblanche1/app/cache/dev/jms_aop',
            'jms_aop.interceptor_loader.class' => 'JMS\\AopBundle\\Aop\\InterceptorLoader',
            'nb.form.news.class' => 'IHQS\\NuitBlancheBundle\\Form\\NewsFormType',
            'nb.form.player.class' => 'IHQS\\NuitBlancheBundle\\Form\\PlayerFormType',
            'nb.form.replay.class' => 'IHQS\\NuitBlancheBundle\\Form\\ReplayFormType',
            'nb.form.user.class' => 'IHQS\\NuitBlancheBundle\\Form\\UserFormType',
            'nb.form.war_new.class' => 'IHQS\\NuitBlancheBundle\\Form\\WarFormType',
            'nb.form.war_game.class' => 'IHQS\\NuitBlancheBundle\\Form\\WarGameFormType',
            'nb.model.comment.class' => 'IHQS\\NuitBlancheBundle\\Entity\\Comment',
            'nb.model.game.class' => 'IHQS\\NuitBlancheBundle\\Entity\\Game',
            'nb.model.game_player.class' => 'IHQS\\NuitBlancheBundle\\Entity\\GamePlayer',
            'nb.model.league.class' => 'IHQS\\NuitBlancheBundle\\Entity\\League',
            'nb.model.news.class' => 'IHQS\\NuitBlancheBundle\\Entity\\News',
            'nb.model.replay.class' => 'IHQS\\NuitBlancheBundle\\Entity\\Replay',
            'nb.model.season.class' => 'IHQS\\NuitBlancheBundle\\Entity\\Season',
            'nb.model.team.class' => 'IHQS\\NuitBlancheBundle\\Entity\\Team',
            'nb.model.user.class' => 'IHQS\\NuitBlancheBundle\\Entity\\User',
            'nb.model.war.class' => 'IHQS\\NuitBlancheBundle\\Entity\\War',
            'nb.model.war_game.class' => 'IHQS\\NuitBlancheBundle\\Entity\\WarGame',
            'nb.model.sc2profile.class' => 'IHQS\\NuitBlancheBundle\\Entity\\SC2Profile',
            'nb.model.wowprofile.class' => 'IHQS\\NuitBlancheBundle\\Entity\\WoWProfile',
            'nb.manager.comment.class' => 'IHQS\\NuitBlancheBundle\\Model\\CommentRepository',
            'nb.manager.game.class' => 'IHQS\\NuitBlancheBundle\\Model\\GameRepository',
            'nb.manager.game_player.class' => 'IHQS\\NuitBlancheBundle\\Model\\GamePlayerRepository',
            'nb.manager.league.class' => 'IHQS\\NuitBlancheBundle\\Model\\LeagueRepository',
            'nb.manager.news.class' => 'IHQS\\NuitBlancheBundle\\Model\\NewsRepository',
            'nb.manager.replay.class' => 'IHQS\\NuitBlancheBundle\\Model\\ReplayRepository',
            'nb.manager.season.class' => 'IHQS\\NuitBlancheBundle\\Model\\SeasonRepository',
            'nb.manager.team.class' => 'IHQS\\NuitBlancheBundle\\Model\\TeamRepository',
            'nb.manager.user.class' => 'IHQS\\NuitBlancheBundle\\Model\\UserRepository',
            'nb.manager.war.class' => 'IHQS\\NuitBlancheBundle\\Model\\WarRepository',
            'nb.manager.war_game.class' => 'IHQS\\NuitBlancheBundle\\Model\\WarGameRepository',
            'nb.manager.sc2profile.class' => 'IHQS\\NuitBlancheBundle\\Model\\SC2ProfileRepository',
            'nb.manager.wowprofile.class' => 'IHQS\\NuitBlancheBundle\\Model\\WoWProfileRepository',
            ...
            'jms_di_extra.cache_dir' => '/var/www/sites/nuitblanche1/app/cache/dev/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/var/www/sites/nuitblanche1/app/cache/dev/jms_diextra/doctrine/EntityManager_50fd523c62b0e.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager50fd523c62b0e_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/var/www/sites/nuitblanche1/app/cache/dev/jms_security',
